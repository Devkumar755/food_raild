...
class AddContinentPage extends GetView<ContinentsController> {
  const AddContinentPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Add Continent")),
                  ...
                  children: [
                    ...
                    Center(
                      child: CustomButton(
                        ...
                        height: 50,
                        onPressed: controller.addContinent,
