...
class UpdateRestaurantPage extends GetView<RestaurantController> {
  final String restaurantId;
  const UpdateRestaurantPage({super.key, required this.restaurantId});

  @override
  Widget build(BuildContext context) {
    final restaurant = controller.restaurants.firstWhereOrNull(
      (r) => r.id == restaurantId,
    );
    if (restaurant != null) {
      controller.setForUpdate(restaurant);
    }
